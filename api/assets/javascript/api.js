//Lets start with some dogs. 
var topics = ['frech bulldog', 'pug', 'boxer dog' ];

$(document).ready(function(){createButtons();
$('#addDogBreed').on('click', function(){addDogBreed();
...
function displayDogBreedInfo(){
    ...
    var queryURL = "https://api.giphy.com/v1/gifs/search?q=" + dogBreed + "&api_key=dc6zaTOxFJmzC&limit=3";
